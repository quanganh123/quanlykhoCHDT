        ...
        <table class="table table-striped table-hover table-sm text-center">
            <thead>
                <tr>
                    ...
                    <th>Số Lượng</th>
                    <th></th>
                    <th><a class="btn btn-info" href="FromAddmewAndroid.php">Thêm mới</a></th>
                </tr>
            </thead>
            <tbody class="myTable">
                <?php foreach ($ListAndroid as $Android) { ?>
                    <tr>
                        ...
                        <td><a class=" btnxs btn btn-success" href="/code/indexAndroid.php?action=update&Id=<?php echo $Android["Id"] ?>">Sửa</a></td>
                        <td><a class=" btnxs btn btn-danger" onclick="return confirm('Bạn có muốn xóa dữ liệu không!');" href="/code/indexAndroid.php?action=delete&Id=<?php echo $Android["Id"] ?> ">Xóa</a></td>
                    </tr>
                <?php } ?>
            </tbody>
        </table>
