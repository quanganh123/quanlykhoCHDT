...
<head>
    ...
    <link rel="stylesheet" href="QLkhoCHDT4.css">
                ...
                <tbody class="myTable">
                    <?php foreach ($ListIos as $Ios) { ?>
                        <tr>
                            ...
                            <td><a class="btn btn-outline-info" onclick="return confirm('Bạn có muốn xóa dữ liệu không!');" href="/code/QLkhoCHDT/index.php?action=delete&Id=<?php echo $Ios["Id"] ?> ">Xóa</a></td>
                        </tr>
                    <?php } ?>
                </tbody>
            </table>
