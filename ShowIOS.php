        ...
        <table class="table table-striped table-hover table-sm text-center">
            <thead>
                <tr>
                    ...
                    <th>Số Lượng</th>
                    <th></th>
                    <th><a class="btn btn-info" href="FromAddmewIos.php">Thêm mới</a></th>
                </tr>
            </thead>
            <tbody class="myTable">
                <?php foreach ($ListIos as $Ios) { ?>
                    <tr>
                        ...
                        <td><a class=" btnxs btn btn-success" href="/code/indexIos.php?action=update&Id=<?php echo $Ios["Id"] ?>">Sửa</a></td>
                        <td><a class=" btnxs btn btn-danger" onclick="return confirm('Bạn có muốn xóa dữ liệu không!');" href="/code/indexIos.php?action=delete&Id=<?php echo $Ios["Id"] ?> ">Xóa</a></td>
                    </tr>
                <?php } ?>
            </tbody>
        </table>
