...
<div class="logo">
    ...
    <div class="namefrom">
        <h4>Quản Lý Điện Thoại Hãng Ios</h4>
    </div>
    <div class="table1">
        <table class="table">
            <tr>
                ...
                <th>Số Lượng</th>
                <th></th>
                <th><a class="btn3" href="FromAddmewIos.php">Thêm mới</a></th>
            </tr>
            <?php foreach ($ListIos as $Ios) { ?>
                <tr class="hover">
                    ...
                    <td><a class="btn2" href="/code/indexIos.php?action=update&Id=<?php echo $Ios["Id"] ?>">Sửa</a></td>
                    <td><a class="btn4" onclick="return confirm('Bạn chắc chắn muốn thoát!');" href="/code/indexIos.php?action=delete&Id=<?php echo $Ios["Id"] ?>">Xóa</a></td>
                </tr>
            <?php } ?>
        </table>
        <?php
